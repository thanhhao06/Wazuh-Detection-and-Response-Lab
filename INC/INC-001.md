...
![[case001-001-script.png]]

### 4.3 Công cụ & Tệp tin Giả lập
...
*   **`win.eventdata.targetUserName` : `soclab-test`**
    ...
    ![[case001-004-target_username.png]]
...
![[case001-008-successful_query.png]]
